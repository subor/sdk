...
class SettingSystemServiceIfSingletonFactory : virtual public SettingSystemServiceIfFactory {
 public:
  SettingSystemServiceIfSingletonFactory(const boost::shared_ptr<SettingSystemServiceIf>& iface) : iface_(iface) {}
 ...
 protected:
  boost::shared_ptr<SettingSystemServiceIf> iface_;
};
...
class SettingSystemServiceClient : virtual public SettingSystemServiceIf {
 public:
  ...
  SettingSystemServiceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class SettingSystemServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  SettingSystemServiceProcessorFactory(const ::boost::shared_ptr< SettingSystemServiceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::boost::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::boost::shared_ptr< SettingSystemServiceIfFactory > handlerFactory_;
};

class SettingSystemServiceMultiface : virtual public SettingSystemServiceIf {
 public:
  SettingSystemServiceMultiface(std::vector<boost::shared_ptr<SettingSystemServiceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~SettingSystemServiceMultiface() {}
 protected:
  std::vector<boost::shared_ptr<SettingSystemServiceIf> > ifaces_;
  SettingSystemServiceMultiface() {}
  void add(boost::shared_ptr<SettingSystemServiceIf> iface) {
...
class SettingSystemServiceConcurrentClient : virtual public SettingSystemServiceIf {
 public:
  SettingSystemServiceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  SettingSystemServiceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {

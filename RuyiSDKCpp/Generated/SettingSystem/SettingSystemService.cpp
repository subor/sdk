...
SettingSystemService_ConnectToAppointedWifi_args::~SettingSystemService_ConnectToAppointedWifi_args() throw() {
}


uint32_t SettingSystemService_ConnectToAppointedWifi_args::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 3:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readString(this->Ciper);
          this->__isset.Ciper = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t SettingSystemService_ConnectToAppointedWifi_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("SettingSystemService_ConnectToAppointedWifi_args");
  ...
  xfer += oprot->writeFieldBegin("Ciper", ::apache::thrift::protocol::T_STRING, 3);
  xfer += oprot->writeString(this->Ciper);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("KeyType", ::apache::thrift::protocol::T_STRING, 4);
...
SettingSystemService_ConnectToAppointedWifi_pargs::~SettingSystemService_ConnectToAppointedWifi_pargs() throw() {
}


uint32_t SettingSystemService_ConnectToAppointedWifi_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("SettingSystemService_ConnectToAppointedWifi_pargs");
...
SettingSystemService_ConnectToAppointedWifi_result::~SettingSystemService_ConnectToAppointedWifi_result() throw() {
}


uint32_t SettingSystemService_ConnectToAppointedWifi_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t SettingSystemService_ConnectToAppointedWifi_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("SettingSystemService_ConnectToAppointedWifi_result");
...
SettingSystemService_ConnectToAppointedWifi_presult::~SettingSystemService_ConnectToAppointedWifi_presult() throw() {
}


uint32_t SettingSystemService_ConnectToAppointedWifi_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
bool SettingSystemServiceClient::ConnectToAppointedWifi(const std::string& profileName, const std::string& Auth, const std::string& Ciper, const std::string& KeyType, const std::string& key)
{
  send_ConnectToAppointedWifi(profileName, Auth, Ciper, KeyType, key);
  return recv_ConnectToAppointedWifi();
}

void SettingSystemServiceClient::send_ConnectToAppointedWifi(const std::string& profileName, const std::string& Auth, const std::string& Ciper, const std::string& KeyType, const std::string& key)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("ConnectToAppointedWifi", ::apache::thrift::protocol::T_CALL, cseqid);

  SettingSystemService_ConnectToAppointedWifi_pargs args;
  args.profileName = &profileName;
  args.Auth = &Auth;
  args.Ciper = &Ciper;
...
bool SettingSystemServiceClient::recv_ConnectToAppointedWifi()
{
  ...
  if (fname.compare("ConnectToAppointedWifi") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  bool _return;
  SettingSystemService_ConnectToAppointedWifi_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "ConnectToAppointedWifi failed: unknown result");
}
...
void SettingSystemServiceProcessor::process_ConnectToAppointedWifi(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("SettingSystemService.ConnectToAppointedWifi", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "SettingSystemService.ConnectToAppointedWifi");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "SettingSystemService.ConnectToAppointedWifi");
  }

  SettingSystemService_ConnectToAppointedWifi_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "SettingSystemService.ConnectToAppointedWifi", bytes);
  }

  SettingSystemService_ConnectToAppointedWifi_result result;
  try {
    ...
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "SettingSystemService.ConnectToAppointedWifi");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("ConnectToAppointedWifi", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "SettingSystemService.ConnectToAppointedWifi");
  }

  oprot->writeMessageBegin("ConnectToAppointedWifi", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "SettingSystemService.ConnectToAppointedWifi", bytes);
  }
}
...
bool SettingSystemServiceConcurrentClient::ConnectToAppointedWifi(const std::string& profileName, const std::string& Auth, const std::string& Ciper, const std::string& KeyType, const std::string& key)
{
  int32_t seqid = send_ConnectToAppointedWifi(profileName, Auth, Ciper, KeyType, key);
  return recv_ConnectToAppointedWifi(seqid);
}

int32_t SettingSystemServiceConcurrentClient::send_ConnectToAppointedWifi(const std::string& profileName, const std::string& Auth, const std::string& Ciper, const std::string& KeyType, const std::string& key)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("ConnectToAppointedWifi", ::apache::thrift::protocol::T_CALL, cseqid);
...
bool SettingSystemServiceConcurrentClient::recv_ConnectToAppointedWifi(const int32_t seqid)
{

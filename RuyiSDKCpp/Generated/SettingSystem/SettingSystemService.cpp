...
::boost::shared_ptr< ::apache::thrift::TProcessor > SettingSystemServiceProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< SettingSystemServiceIfFactory > cleanup(handlerFactory_);
  ::boost::shared_ptr< SettingSystemServiceIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::boost::shared_ptr< ::apache::thrift::TProcessor > processor(new SettingSystemServiceProcessor(handler));
  return processor;
}

...
SettingSystemService_GetBluetoothDevice_args::~SettingSystemService_GetBluetoothDevice_args() throw() {
}


uint32_t SettingSystemService_GetBluetoothDevice_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t SettingSystemService_GetBluetoothDevice_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("SettingSystemService_GetBluetoothDevice_args");
...
SettingSystemService_GetBluetoothDevice_pargs::~SettingSystemService_GetBluetoothDevice_pargs() throw() {
}


uint32_t SettingSystemService_GetBluetoothDevice_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("SettingSystemService_GetBluetoothDevice_pargs");
...
SettingSystemService_GetBluetoothDevice_result::~SettingSystemService_GetBluetoothDevice_result() throw() {
}


uint32_t SettingSystemService_GetBluetoothDevice_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t SettingSystemService_GetBluetoothDevice_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("SettingSystemService_GetBluetoothDevice_result");

  if (this->__isset.success) {
    xfer += oprot->writeFieldBegin("success", ::apache::thrift::protocol::T_LIST, 0);
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->success.size()));
      std::vector< ::Ruyi::SDK::SettingSystem::Api::BluetoothDevice> ::const_iterator _iter75;
...
SettingSystemService_GetBluetoothDevice_presult::~SettingSystemService_GetBluetoothDevice_presult() throw() {
}


uint32_t SettingSystemService_GetBluetoothDevice_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void SettingSystemServiceClient::GetBluetoothDevice(std::vector< ::Ruyi::SDK::SettingSystem::Api::BluetoothDevice> & _return)
{
  send_GetBluetoothDevice();
  recv_GetBluetoothDevice(_return);
}

void SettingSystemServiceClient::send_GetBluetoothDevice()
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("GetBluetoothDevice", ::apache::thrift::protocol::T_CALL, cseqid);

  SettingSystemService_GetBluetoothDevice_pargs args;
  args.write(oprot_);
...
void SettingSystemServiceClient::recv_GetBluetoothDevice(std::vector< ::Ruyi::SDK::SettingSystem::Api::BluetoothDevice> & _return)
{
  ...
  if (fname.compare("GetBluetoothDevice") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  SettingSystemService_GetBluetoothDevice_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "GetBluetoothDevice failed: unknown result");
}
...
void SettingSystemServiceProcessor::process_GetBluetoothDevice(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("SettingSystemService.GetBluetoothDevice", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "SettingSystemService.GetBluetoothDevice");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "SettingSystemService.GetBluetoothDevice");
  }

  SettingSystemService_GetBluetoothDevice_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "SettingSystemService.GetBluetoothDevice", bytes);
  }

  SettingSystemService_GetBluetoothDevice_result result;
  try {
    iface_->GetBluetoothDevice(result.success);
    result.__isset.success = true;
  } catch ( ::Ruyi::SDK::CommonType::ErrorException &error1) {
    result.error1 = error1;
    result.__isset.error1 = true;
    ...
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "SettingSystemService.GetBluetoothDevice");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("GetBluetoothDevice", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "SettingSystemService.GetBluetoothDevice");
  }

  oprot->writeMessageBegin("GetBluetoothDevice", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "SettingSystemService.GetBluetoothDevice", bytes);
  }
}
...
void SettingSystemServiceConcurrentClient::GetBluetoothDevice(std::vector< ::Ruyi::SDK::SettingSystem::Api::BluetoothDevice> & _return)
{
  int32_t seqid = send_GetBluetoothDevice();
  recv_GetBluetoothDevice(_return, seqid);
}

int32_t SettingSystemServiceConcurrentClient::send_GetBluetoothDevice()
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("GetBluetoothDevice", ::apache::thrift::protocol::T_CALL, cseqid);
...
void SettingSystemServiceConcurrentClient::recv_GetBluetoothDevice(std::vector< ::Ruyi::SDK::SettingSystem::Api::BluetoothDevice> & _return, const int32_t seqid)
{

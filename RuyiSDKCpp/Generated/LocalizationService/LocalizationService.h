...
class LocalizationServiceIfSingletonFactory : virtual public LocalizationServiceIfFactory {
 public:
  LocalizationServiceIfSingletonFactory(const boost::shared_ptr<LocalizationServiceIf>& iface) : iface_(iface) {}
 ...
 protected:
  boost::shared_ptr<LocalizationServiceIf> iface_;
};
...
class LocalizationServiceClient : virtual public LocalizationServiceIf {
 public:
  LocalizationServiceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  LocalizationServiceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class LocalizationServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  LocalizationServiceProcessor(boost::shared_ptr<LocalizationServiceIf> iface) :
    iface_(iface) {
...
class LocalizationServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  LocalizationServiceProcessorFactory(const ::boost::shared_ptr< LocalizationServiceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::boost::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::boost::shared_ptr< LocalizationServiceIfFactory > handlerFactory_;
};

class LocalizationServiceMultiface : virtual public LocalizationServiceIf {
 public:
  LocalizationServiceMultiface(std::vector<boost::shared_ptr<LocalizationServiceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~LocalizationServiceMultiface() {}
 protected:
  std::vector<boost::shared_ptr<LocalizationServiceIf> > ifaces_;
  LocalizationServiceMultiface() {}
  void add(boost::shared_ptr<LocalizationServiceIf> iface) {
...
class LocalizationServiceConcurrentClient : virtual public LocalizationServiceIf {
 public:
  LocalizationServiceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  LocalizationServiceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {

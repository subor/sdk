...
inline std::ostream& operator<<(std::ostream& out, const RuyiGamePadInput& obj)
{
  obj.printTo(out);
  return out;
}
...
inline std::ostream& operator<<(std::ostream& out, const RuyiKeyboardInput& obj)
{
  obj.printTo(out);
  return out;
}
...
inline std::ostream& operator<<(std::ostream& out, const RuyiMouseInput& obj)
{
  obj.printTo(out);
  return out;
}

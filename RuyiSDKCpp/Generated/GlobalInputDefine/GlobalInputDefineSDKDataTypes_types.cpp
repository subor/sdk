...
std::ostream& operator<<(std::ostream& out, const RuyiInputDeviceType::type& val) {
  std::map<int, const char*>::const_iterator it = _RuyiInputDeviceType_VALUES_TO_NAMES.find(val);
  if (it != _RuyiInputDeviceType_VALUES_TO_NAMES.end()) {
    out << it->second;
  } else {
...
std::ostream& operator<<(std::ostream& out, const GamepadButtonFlags::type& val) {
  std::map<int, const char*>::const_iterator it = _GamepadButtonFlags_VALUES_TO_NAMES.find(val);
  if (it != _GamepadButtonFlags_VALUES_TO_NAMES.end()) {
    out << it->second;
  } else {
    out << static_cast<int>(val);
  }
...
std::ostream& operator<<(std::ostream& out, const RuyiControllerKey::type& val) {
  std::map<int, const char*>::const_iterator it = _RuyiControllerKey_VALUES_TO_NAMES.find(val);
  if (it != _RuyiControllerKey_VALUES_TO_NAMES.end()) {
    out << it->second;
  } else {
    out << static_cast<int>(val);
  }
...
std::ostream& operator<<(std::ostream& out, const RuyiActionActivateEvent::type& val) {
  std::map<int, const char*>::const_iterator it = _RuyiActionActivateEvent_VALUES_TO_NAMES.find(val);
  if (it != _RuyiActionActivateEvent_VALUES_TO_NAMES.end()) {
    out << it->second;
  } else {
    out << static_cast<int>(val);
  }
...
std::ostream& operator<<(std::ostream& out, const Gamepad& obj)
{
  obj.printTo(out);
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const RuyiInputStateXB360& obj)
{
  obj.printTo(out);
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const RuyiInputStateKeyboard& obj)
{
  obj.printTo(out);
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const RuyiInputStateMouse& obj)
{
  obj.printTo(out);
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const RuyiInputStateGamepad& obj)
{
  obj.printTo(out);
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const RuyiInputStateJoystick& obj)
{
  obj.printTo(out);
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const RuyiInputStateRuyiController& obj)
{
  obj.printTo(out);
  return out;
}

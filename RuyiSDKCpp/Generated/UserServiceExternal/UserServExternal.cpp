...
::boost::shared_ptr< ::apache::thrift::TProcessor > UserServExternalProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< UserServExternalIfFactory > cleanup(handlerFactory_);
  ::boost::shared_ptr< UserServExternalIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::boost::shared_ptr< ::apache::thrift::TProcessor > processor(new UserServExternalProcessor(handler));
  return processor;
}

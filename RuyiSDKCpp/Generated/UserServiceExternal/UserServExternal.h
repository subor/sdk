...
class UserServExternalIfSingletonFactory : virtual public UserServExternalIfFactory {
 public:
  UserServExternalIfSingletonFactory(const boost::shared_ptr<UserServExternalIf>& iface) : iface_(iface) {}
 ...
 protected:
  boost::shared_ptr<UserServExternalIf> iface_;
};
...
class UserServExternalClient : virtual public UserServExternalIf {
 public:
  UserServExternalClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  UserServExternalClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class UserServExternalProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  UserServExternalProcessor(boost::shared_ptr<UserServExternalIf> iface) :
    iface_(iface) {
...
class UserServExternalProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  UserServExternalProcessorFactory(const ::boost::shared_ptr< UserServExternalIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::boost::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::boost::shared_ptr< UserServExternalIfFactory > handlerFactory_;
};

class UserServExternalMultiface : virtual public UserServExternalIf {
 public:
  UserServExternalMultiface(std::vector<boost::shared_ptr<UserServExternalIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~UserServExternalMultiface() {}
 protected:
  std::vector<boost::shared_ptr<UserServExternalIf> > ifaces_;
  UserServExternalMultiface() {}
  void add(boost::shared_ptr<UserServExternalIf> iface) {
...
class UserServExternalConcurrentClient : virtual public UserServExternalIf {
 public:
  UserServExternalConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  UserServExternalConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {

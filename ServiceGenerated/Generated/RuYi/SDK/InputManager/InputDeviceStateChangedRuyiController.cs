...
namespace Ruyi.SDK.InputManager
{
  ...
  [Serializable]
  #endif
  public partial class InputDeviceStateChangedRuyiController : TBase
  {
    ...
    public InputDeviceStateChangedRuyiController() {
    }
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("InputDeviceStateChangedRuyiController");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("InputDeviceStateChangedRuyiController(");
      bool __first = true;
      if (__isset.PacketId) {

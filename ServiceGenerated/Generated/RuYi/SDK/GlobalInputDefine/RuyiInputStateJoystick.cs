...
namespace Ruyi.SDK.GlobalInputDefine
{
  ...
  [Serializable]
  #endif
  public partial class RuyiInputStateJoystick : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("RuyiInputStateJoystick");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("RuyiInputStateJoystick(");
      bool __first = true;
      if (__isset.RawOffset) {

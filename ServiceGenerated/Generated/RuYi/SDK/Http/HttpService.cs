...
namespace Ruyi.SDK.Http
{
  public partial class HttpService {
    ...
    public interface IAsync {
      Task<Ruyi.SDK.Http.SubscribeReply> SubscribeAsync(Ruyi.SDK.Http.SubscribeRequest msg);
    }
    ...
    public class Client : IDisposable, Iface {
      ...
      public async Task<Ruyi.SDK.Http.SubscribeReply> SubscribeAsync(Ruyi.SDK.Http.SubscribeRequest msg)
      {
    ...
    public class AsyncProcessor : TAsyncProcessor {
      ...
      public async Task Subscribe_ProcessAsync(int seqid, TProtocol iprot, TProtocol oprot)
      {
        ...
        try
        {
          result.Success = await iface_.SubscribeAsync(args.Msg);

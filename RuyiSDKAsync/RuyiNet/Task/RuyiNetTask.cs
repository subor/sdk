...
namespace Ruyi.SDK.Online
{
    ...
    public class RuyiNetPlatformTask<Response> : RuyiNetTask<Response>
    {
        ...
        {
            Completed = false;
            mClient.BCService.Identity_SwitchToParentProfileAsync("RUYI", mIndex, token).Wait();
            base.Response = OnExecute();
            mClient.BCService.Identity_SwitchToSingletonChildProfileAsync(mClient.AppId, false, mIndex, token).Wait();
            Completed = true;
        }
